  ...
  <img
    src={
      userData.profile_img
        ? `${process.env.REACT_APP_API_URL}${userData.profile_img}`
        : `https://ui-avatars.com/api/?name=${
            encodeURIComponent(userData.full_name || userData.email.split('@')[0])
          }&background=f43f5e&color=fff&rounded=true&size=150`
    }
    alt="Profile"
  />
</div>
          ...
          {editMode ? (
            ...
            <div className="profile-details">
              ...
              <p><strong>Member since:</strong> {new Date(userData.created_at).toLocaleDateString('fr-FR', {
